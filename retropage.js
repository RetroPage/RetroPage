...
window.onload = function() {
	...
	function dosearch() {
		...
		if (savedsearch == "google") {
			...
			return false;
		} else if (savedsearch == "ecosia") {
			window.location.href = "https://www.ecosia.org/search?q=" + escape(searchbox.searchtext.value);
			return false;
	...
	function setengine() {
		...
		if (selectedsearch == "google") {
			...
			savedsearch = localStorage.getItem("selectedengine");
		} else if (selectedsearch == "ecosia") {
			$('input[name="searchtext"]').attr("placeholder", "Ecosia Search");
			localStorage.setItem("selectedengine", "ecosia");
			savedsearch = localStorage.getItem("selectedengine");
	...
	//function to change autocomplete
